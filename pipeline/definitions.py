...
from pipeline.assets.ingestion import crime_assets #Our ingestion assets
...
defs = Definitions(
    assets=crime_assets + duckdb_warehouse + [dbt_project_assets],  # Include all MTA and DBT assets
    resources=resources
)